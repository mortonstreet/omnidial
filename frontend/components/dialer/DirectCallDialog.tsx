              ...
              {phoneNumbersLoading ? (
                ...
                <div className="relative">
                  {(() => {
                    ...
                    const locationText =
                      selectedPhone &&
                      (selectedPhone.locality || selectedPhone.region)
                        ? [selectedPhone.locality, selectedPhone.region]
                            .filter(Boolean)
                            .join(', ')
                        : null
                    ...
                    return (
                      ...
                      >
                        ...
                        <ChevronDown
                          className={`w-4 h-4 transition-transform ${showNumberSelector ? 'rotate-180' : ''}`}
                        />
                      </button>
                    )
                  })()}
            ...
            {isCallActive ? (
              ...
              <button
                ...
                className={`w-16 h-16 flex items-center justify-center rounded-full bg-emerald-500 hover:bg-emerald-400 text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:shadow-none ${
                  phoneNumber && !isDialing && selectedFromNumber
                    ? 'animate-pulse'
                    : ''
                }`}
              >
