...
export const CampaignLeadStatusSchema = z.enum([
  'pending',
  'dialed',
  'completed',
])
...
export const ListLeadsRequestSchema = PaginationRequestSchema.extend({
  ...
  titleFilter: z
    ...
    .transform((val) => {
      ...
      try {
        return SmartFilterSchema.parse(JSON.parse(val))
      } catch {
        return undefined
      }
    }),
...
const nullableUrlSchema = z.preprocess(emptyStringToNull, urlSchema.nullable())
...
export const UpdateLeadRequestSchema = z.object({
  ...
  phone: nullablePhoneSchema.optional(), // Allows clearing phone for "wrong number" disposition
  company: z.string().trim().max(255).nullable().optional(),
  title: z.string().trim().max(255).nullable().optional(),
  linkedInUrl: nullableUrlSchema.optional(),
...
export type BulkCreateLeadsRequest = z.infer<
  typeof BulkCreateLeadsRequestSchema
>
...
export type BulkAddToCampaignRequest = z.infer<
  typeof BulkAddToCampaignRequestSchema
>
...
export type BulkAddToPipelineRequest = z.infer<
  typeof BulkAddToPipelineRequestSchema
>
...
export type GetLeadActivityRequest = z.infer<
  typeof GetLeadActivityRequestSchema
>
...
export type GenerateCompanySummaryRequest = z.infer<
  typeof GenerateCompanySummaryRequestSchema
>
