...
export type ParallelDialSessionStatus = z.infer<
  typeof ParallelDialSessionStatus
>
...
export type ParallelDialAttemptStatus = z.infer<
  typeof ParallelDialAttemptStatus
>
...
export type StartParallelDialSessionRequest = z.infer<
  typeof StartParallelDialSessionRequestSchema
>

export const EndParallelDialSessionRequestSchema = z.object({
  sessionId: z.string().uuid(),
})
export type EndParallelDialSessionRequest = z.infer<
  typeof EndParallelDialSessionRequestSchema
>

export const PauseParallelDialSessionRequestSchema = z.object({
  sessionId: z.string().uuid(),
})
export type PauseParallelDialSessionRequest = z.infer<
  typeof PauseParallelDialSessionRequestSchema
>

export const ResumeParallelDialSessionRequestSchema = z.object({
  sessionId: z.string().uuid(),
})
export type ResumeParallelDialSessionRequest = z.infer<
  typeof ResumeParallelDialSessionRequestSchema
>

export const GetParallelDialSessionRequestSchema = z.object({
  id: z.string().uuid(),
})
export type GetParallelDialSessionRequest = z.infer<
  typeof GetParallelDialSessionRequestSchema
>
...
export type ListParallelDialSessionsRequest = z.infer<
  typeof ListParallelDialSessionsRequestSchema
>
...
export type GetAbandonedCallsReportRequest = z.infer<
  typeof GetAbandonedCallsReportRequestSchema
>
