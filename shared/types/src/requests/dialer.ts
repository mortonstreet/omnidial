...
export type GetTwilioConfigRequest = z.infer<
  typeof GetTwilioConfigRequestSchema
>
...
export type CreateTwilioConfigRequest = z.infer<
  typeof CreateTwilioConfigRequestSchema
>
...
export type UpdateTwilioConfigRequest = z.infer<
  typeof UpdateTwilioConfigRequestSchema
>
...
export type UpdateCallDispositionRequest = z.infer<
  typeof UpdateCallDispositionRequestSchema
>
...
export type GetVoicemailDropRequest = z.infer<
  typeof GetVoicemailDropRequestSchema
>
...
export type ListVoicemailDropsRequest = z.infer<
  typeof ListVoicemailDropsRequestSchema
>
...
export type CreateVoicemailDropRequest = z.infer<
  typeof CreateVoicemailDropRequestSchema
>

export const DeleteVoicemailDropRequestSchema = z.object({
  id: z.string().uuid(),
})
export type DeleteVoicemailDropRequest = z.infer<
  typeof DeleteVoicemailDropRequestSchema
>
...
export type ListDispositionsRequest = z.infer<
  typeof ListDispositionsRequestSchema
>
...
export type CreateDispositionRequest = z.infer<
  typeof CreateDispositionRequestSchema
>
...
export type UpdateDispositionRequest = z.infer<
  typeof UpdateDispositionRequestSchema
>

export const DeleteDispositionRequestSchema = z.object({
  id: z.string().uuid(),
})
export type DeleteDispositionRequest = z.infer<
  typeof DeleteDispositionRequestSchema
>
...
export type GetCapabilityTokenRequest = z.infer<
...
export type UnassignPhoneNumberRequest = z.infer<
  typeof UnassignPhoneNumberRequestSchema
>

// No clientId: the dialable set is the caller's own numbers, derived from the
// authenticated session rather than passed in.
export const GetDialablePhoneNumbersRequestSchema = z.object({
  organizationId: z.string().min(1),
})
export type GetDialablePhoneNumbersRequest = z.infer<
  typeof GetDialablePhoneNumbersRequestSchema
>
...
export type StartDialerSessionRequest = z.infer<
  typeof StartDialerSessionRequestSchema
>

export const EndDialerSessionRequestSchema = z.object({
  sessionId: z.string().uuid(),
})
export type EndDialerSessionRequest = z.infer<
  typeof EndDialerSessionRequestSchema
>
...
export type GetActiveSessionsRequest = z.infer<
  typeof GetActiveSessionsRequestSchema
>
...
export type ListVoicemailGreetingsRequest = z.infer<
  typeof ListVoicemailGreetingsRequestSchema
>
...
export type CreateVoicemailGreetingRequest = z.infer<
  typeof CreateVoicemailGreetingRequestSchema
>

export const SetActiveVoicemailGreetingRequestSchema = z.object({
  id: z.string().uuid(),
})
export type SetActiveVoicemailGreetingRequest = z.infer<
  typeof SetActiveVoicemailGreetingRequestSchema
>

export const DeleteVoicemailGreetingRequestSchema = z.object({
  id: z.string().uuid(),
})
export type DeleteVoicemailGreetingRequest = z.infer<
  typeof DeleteVoicemailGreetingRequestSchema
>
...
export type MarkVoicemailReadRequest = z.infer<
  typeof MarkVoicemailReadRequestSchema
>

export const MarkAllVoicemailsReadRequestSchema = z.object({})
export type MarkAllVoicemailsReadRequest = z.infer<
  typeof MarkAllVoicemailsReadRequestSchema
>
